...
<section class="account-form">
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <p class="placehoder">Your name <span>*</span></p>
        <input type="text" name="name" require maxlength="50"
        placeholder="Enter your name" class="box">
        <p class="placehoder">Your email <span>*</span></p>
        <input type="email" name="email" required maxlength="50" 
        placeholder="Enter your email" class="box">
        <p class="placehoder">Your password <span>*</span></p>
        <input type="password" name="pass" require maxlength="50"
        placeholder="Enter your password" class="box">
        <p class="placehoder">Confirm password <span>*</span></p>
        <input type="password" name="c_pass" require maxlength="50"
